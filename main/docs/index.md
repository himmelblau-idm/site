  ...
  <section class="hb-chapter hb-chapter--cloud" aria-labelledby="sso-title">
    ...
    <div class="hb-scene hb-shell" data-hb-scene>
      ...
      <div class="hb-scene__steps">
        ...
        <article class="hb-step" data-hb-step><span>03</span><h3>Microsoft 365 on Linux</h3><p>Mail, meetings, documents, spreadsheets, and presentations remain connected to the same authenticated identity.</p></article>
      </div>
    </div>
  </section>
