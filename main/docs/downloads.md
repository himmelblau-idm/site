...
<div class="hb-install-panel">
  <p>Run this in your terminal, then follow the onscreen instructions. The interactive installer supports Microsoft Entra ID, Microsoft personal accounts with a required explicit account allow-list, and generic OIDC providers.</p>
